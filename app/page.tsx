...
function getChapterDescription(num: number | null): string {
  const descriptions: Record<number, string> = {
    ...
    7: "The recommended process for agent work — from input to review to improvement.",
    8: "Step-by-step: gathering source material, generating a voice skill, and wiring it together.",
