## Chapter 12: Claude Built-in Capabilities
...
The real power comes when you combine built-in commands with the custom configuration from Chapter 6 — your own commands, skills, and agents layered on top of the defaults. Chapter 13 shows what that looks like at scale: a full software development system with seven custom agents, five commands, and rules that evolve with every project.
